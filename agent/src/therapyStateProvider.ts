...
import { formatTherapyStateAsString, getTherapyState, TherapyStateStatus } from "./therapyState";
...
export const therapyStateProvider: Provider = {
    get: async (runtime: IAgentRuntime, message: Memory, state: State) => {
        ...
        switch (therapyState.status) {
            case null:
                result += "\n\n" + runtime.character.templates?.collectingTherapyDataTemplate || collectingTherapyDataTemplate;
                break;
            ...
            case TherapyStateStatus.DATA_COLLECTED:
                result += "\n\n" + runtime.character.templates?.therapyDataCollectedTemplate || therapyDataCollectedTemplate;
        }
